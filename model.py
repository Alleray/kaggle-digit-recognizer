...
if not os.path.isfile('model.h5'):
    ...
    print('Fitting model...')
    model.fit(x=X_train, y=Y_train_oh, epochs=100, batch_size=1000)
...
predictions = model.predict(x=test_data, verbose=1, batch_size=1000)
